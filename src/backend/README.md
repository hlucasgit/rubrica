...
src/backend/
  ...
  tests/SecureSign.UnitTests/     # 60 pruebas — lógica de dominio + PAdES/CMS/TSA (RUNBOOK 12.15) + SecureSign.Trust (RUNBOOK 12.17)
